...
namespace CyberRunner
{
    public class Node
    {
        ...
        public string Text;
        public int Branch;
        public SkillCheck Check = new(0, -1);
    ...
    public static class Script
    {
        ...
        public static readonly Tuple<Node, Choice[]>[] Scripts =
        {
            ...
            CreateCommonLine(1, Technics,
                "Умные люди не полагаются на свои силы. Да и зачем, когда есть технологии? {Техника + 1}", 0),
            ...
            CreateCommonLine(0, 0, "Клод, я устала от этих механизмов, почему нельзя просто по-человечески поговорить?",
                0),
            ...
            CreateCommonLine(0, 0,
                "Прибыв в участок ты следуешь в кабинет к твоему начальнику: грузному серьезному человеку " +
            ...
            Tuple.Create(new Node(0, 0,
                ...
                new[]
                {
                    ...
                    new Choice("Я сделаю это как подобает Клоду Бернару ((Тело > 7) {Техника + 2}) ",
                        new SkillCheck(Body, 8)),
                    new Choice("Эти дроиды заплатят за офицера Коума, можете быть уверены (Эмпатия > 5)",
                        new SkillCheck(Empathy, 6))
                }
            ),
            ...
            CreateCommonLine(2, Technics, "Перед уходом вы берете с собой свежий выпуск \"Механизмы и пули\"" +
                                          " и плазмаревольвер", 1),
            CreateCommonLine(0, 0,
                "Прошу без глупостей, офицер. Вы должны быть холодны. Андроидам чужды переживания и страх", 2),
            ...
            CreateCommonLine(0, 0,
                "Вы калибруете тест на сотрудниках, и к вам подходит женщина - Рейчел и представляется как " +
                "наследница компании"),
            CreateCommonLine(0, 0,
                "Тест она проходит хорошо, но на некоторых вопросах стрелка эмпатии не колеблется совсем"),
            Tuple.Create(new Node(0, 0,
                    "-Все хорошо, офицер?"),
                new[]
                {
            ...
            CreateCommonLine(0, 0,
                "-Видите ли, Клод, дело в том, что Рейчел провела первые четырнадцать лет своей жизни" +
            ...
            Tuple.Create(new Node(0, 0,
                ...
                new[]
                {
                    ...
                    new Choice("Похоже придется сообщить начальству, говорите вы, раздасадованно",
                        new SkillCheck(0, -1)),
                    new Choice("Я верю только технологиям, они никогда меня не обманут (Техника > 5)",
                        new SkillCheck(Technics, 6))
                }
            ),
            ...
            CreateCommonLine(0, 0,
                "Шандор - офицер из русского отделения, он тоже знает о Полокове и предлагает свою помощь."),
            ...
            CreateCommonLine(0, 0,
                "Спустя нескольких минут осмотра вы приходите к выводу, что это был не кто иной как" +
                " Макс Полоков", 0),
            ...
            CreateCommonLine(-7, Health, "Шандор делает 3 выстрела навскидку, один из них ранит вашу ногу {Жизнь - 7}",
                1),
            ...
            CreateCommonLine(0, 0,
                "Дома вас несколько раз вызывают в участок, но вы определенно не в состоянии туда идти"),
            ...
            CreateCommonLine(0, 0,
                "В театре вы видите несколько охранников, людей, которые собрались в небольшие группы. " +
            ...
            CreateCommonLine(0, 0,
                "Перед вами дверь с большой золотой звездой. Вы уверены, что это гримерка Любы, к тому же только " +
            ...
            CreateCommonLine(0, 0,
                "-Ты что, первый день здесь? *ты толкаешь его руку*. Еще раз такое увижу - будешь пепел с улицы подметать.",
                1),
            ...
            CreateCommonLine(0, 0,
                "-Вы подозреваетесь в престпуплении, Вы имеете право хранить молчание. Всё, что вы скажете..."),
            CreateCommonLine(0, 0, "-ааАаААаа, уберите от меня свои лапы"),
            CreateCommonLine(0, 0, "В комнату входят два охранника"),
            CreateCommonLine(0, 0,
                " Люба вызывает полицию, обвинив Клода в сексуальных домогательствах. Клода доставляют в управление, о существовании которого он даже и не подозревал."),
            CreateCommonLine(0, 0,
                "Там его поручают офицеру Гарленду, который, как обнаруживается, есть в Клодовском списке на усыпление. Для того, чтобы понять, что происходит, вызывают охотника за премиальными Фила Реша, который приписан к управлению. После того, как анализом костного мозга подтверждается, что Полоков был андроидом, Реш и Гарленд вступают в спор о целесообразности применении теста Бонелли к сотрудникам управления. "),
            CreateCommonLine(0, 0,
                "Реш выходит за оборудованием, а Гарленд признается Клоду, что он и все сотрудники его управления, включая Реша, являются андроидами, проникшими на Землю с Марса. Однако, по словам Гарленда, Реш еще не знает, что он сам и все его коллеги - андроиды, так как ему вживили искусственную память."),
            CreateCommonLine(0, 0,
                "После этого, Гарленд достаёт лазерный пистолет, но колеблется, применять ли его. Реш возвращается, убивает Гарленда и вместе с Клодом покидает управление."),
            CreateCommonLine(0, 0,
                "После того, как они вдвоём усыпляют Любу Люфт, Клод проводит тест Войта — Кампфа на Реше, который уже и сам боится, что он андроид. Клод же в этом почти уверен, видя, с какой готовностью и удовольствием Реш усыпляет андроидов, но результаты теста не подтверждают его подозрения."),
            CreateCommonLine(0, 0,
                "Клод всё более обеспокоен тем сочувствием, которое вызывают у него андроиды, в особенности женщины. В депрессии он покупает в кредит козу черной нубийской породы, потратив все премиальные на первый взнос."),
            CreateCommonLine(0, 0,
                "Последние три андроида с мозгом модели «Нексус-6» скрываются в заброшенном пригородном доме вместе с Джоном Изидором, «пустоголовым» (так называют людей, чей мозг слишком пострадал от радиации; им запрещено эмигрировать с Земли). "),
            CreateCommonLine(0, 0,
                "Изидор относится к андроидам дружелюбно, хотя они относятся к нему безразлично. Обнаружив живого паука, они не задумываясь отрывают ему лапки одну за одной, чтобы проверить, сколько ему нужно, чтобы передвигаться."),
            CreateCommonLine(0, 0,
                "Начальник Клода настаивает, чтобы он усыпил оставшихся трёх \"анди\" в тот же день, пока они не перебрались в другое место. Клод решает, что ему нужна помощь Рейчел Роузен и назначает ей встречу в отеле в Сан-Франциско."),
            CreateCommonLine(0, 0,
                "При встрече они пьют настоящий довоенный бурбон и после беседы о трёх оставшихся андроидах занимаются сексом. Рейчел признаётся, что спала со многими охотниками за премиальными, и все они, кроме Фила Реша, оставили работу."),
            CreateCommonLine(0, 0,
                "Тогда Клод грозится убить её, но осознает, что не может. Роузены добились определённого успеха, но Клод всё же продолжает своё задание."),
            CreateCommonLine(0, 0,
                "Клод прибывает в дом Изидора, чтобы \"усыпить\" оставшихся андроидов. Появляется Мерсер и даёт Клоду силы убить Прис Стрэттон — точную копию Рейчел. После этого Клод легко усыпляет двух оставшихся андроидов. Вернувшись домой, он узнаёт, что Рейчел убила козу, столкнув её с крыши. "),
            CreateCommonLine(0, 0,
                "Клод отправляется в последнее путешествие на своём ховере, в орегонскую пустыню. Там он поднимается на холм, подобно Мерсеру, но в него попадает камень, и он идёт обратно к машине. По пути он находит живую жабу (в каталоге Сидни жабы обозначены как вымерший вид) и возвращается домой."),
            CreateCommonLine(0, 0,
                "Но дома его жена Елизавета обнаруживает, что жаба искусственная. Когда Клод засыпает, она заказывает для жабы фунт электромух. The end"),
